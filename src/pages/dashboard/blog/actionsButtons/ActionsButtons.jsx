...
import {deleteBlog} from "../../../../Redux/Reducers/blogSlice.js";
import {useDispatch} from "react-redux";
import ConfirmationModal from "../../../../components/dashboard/Popup/ConfirmationModal.jsx";
import {useEffect, useState} from "react";

export default function ActionsButtons({blogId}) {
  ...
  return (
    <>
        ...
        <Link className="btn" to={'edit'} title='Edit'>
        ...
        <button className="btn" title='Delete' onClick={deleteBlogFunction()}>
